function pre_processor_trailing
...
S.axle1_radiobutton = uicontrol(S.axlesnumber_panel,...
                                'Style','radiobutton',...
                                'String','1',...
                                'backgroundcolor','w',...
                                'Units','Normalized',...
...
S.axle5_radiobutton = uicontrol(S.axlesnumber_panel,...
                                'Style','radiobutton',...
                                'String','5',...
                                'backgroundcolor','w',...
                               'FontSize',8,...
...
S.axle5xpos_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                           'Units','normalized',...
                           'Position',[.6 .9 .3 .065],...
                           'FontSize',7,...
                           'FontUnits','Normalized');
                       
S.axle5xpos_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.9 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','X position (m)',...
...
S.axle5trackwidth_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                                 'Units','normalized',...
                                 'Position',[.6 .81 .3 .065],...
                                 'FontSize',7,...
                           'FontUnits','Normalized');

S.axle5trackwidth_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.81 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Distance ''D'' (m)',...
...
S.axle5zrollcenter_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                                  'Units','normalized',...
                                  'Position',[.6 .72 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                              
S.axle5zrollcenter_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.72 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Roll center Z position(m)',...
...
S.axle5yd_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                         'Units','normalized',...
                         'Position',[.6 .63 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                     
S.axle5yd_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.63 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Y distance btw dampers (m)',...
...
S.axle5ys_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                         'Units','normalized',...
                         'Position',[.6 .54 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                     
S.axle5ys_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.54 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Y distance btw springs (m)',...
...
S.axle5fzstat_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                             'Units','normalized',...
                             'Position',[.6 .45 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                         
S.axle5fzstat_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.45 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Initial load (N)',...
...
S.axle5mass_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                           'Units','normalized',...
                           'Position',[.6 .36 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                       
S.axle5mass_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.36 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Mass excl wheels/tyres (kg)',...
...
S.axle5damper_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                             'Units','normalized',...
                             'Position',[.6 .27 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                         
S.axle5damper_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.27 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Damper constant (Ns/m)',...
...
S.axle5spring_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                             'Units','normalized',...
                             'Position',[.6 .18 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');
                         
S.axle5spring_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.18 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Spring stiffness (N/m)',...
...
S.axle5roll_edit = uicontrol(S.panel_axle_5,'Style','edit',...
                           'Units','normalized',...
                           'Position',[.6 0.09 .3 .065],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');  
                       
S.axle5roll_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0.09 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Roll stiffness (Nm/rad)',...
...
S.axle5tyres_popupmenu = uicontrol(S.panel_axle_5,'Style','popupmenu',...
                                 'String',filelist,...
                                 'Units','Normalized',...
                                 'Position',[0.6 0 0.35 .065],...
                                  'FontSize',7,...
...
S.axle5tyres_text = uicontrol(S.panel_axle_5,'Style','text',...
                             'Units','Normalized',...
                             'Position',[0.1 0 0.45 0.065],...
                             'backgroundcolor','w',...
                             'String','Tyres',...
...
S.chassislenght_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                 'Units','normalized',...
                                 'Position',[.65 .9 .3 .06],...
                                 'FontSize',7,...
                           'FontUnits','Normalized'); 
                                
S.chassislenght_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.chassisheight_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .8 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 

S.chassisheight_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.chassiswidth_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .7 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 

S.chassiswidth_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.chassismass_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .6 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 

S.chassismass_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.ftoconn_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .5 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 

S.ftoconn_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.dbmass_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .4 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 
                              
S.dbmass_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.connectionxpos_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .3 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized'); 
                              
S.connectionxpos_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
S.connectionzpos_edit = uicontrol(S.chassis_panel,'Style','edit',...
                                    'Units','normalized',...
                                    'Position',[.65 .2 .3 .06],...
                                  'FontSize',7,...
                           'FontUnits','Normalized');                               

S.connectionzpos_text = uicontrol(S.chassis_panel,'Style','text',...
                             'Units','Normalized',...
...
a=0;
if t2==5 
    set(S.axle1_radiobutton,'Visible','off')
    set(S.axle5_radiobutton,'Visible','off')
elseif t2==6
    set(S.axle5_radiobutton,'Visible','off')
end
...
global start_window S filelist
start_window=0;
global a axle_dolly axle_trailer name p t2 trailer_code d p2name
d = 0;
if (get(S.axle1_radiobutton,'Value') == get(S.axle2_radiobutton,'Max'))
    a=1;
elseif (get(S.axle2_radiobutton,'Value') == get(S.axle2_radiobutton,'Max'))
    a=2;
elseif (get(S.axle3_radiobutton,'Value') == get(S.axle2_radiobutton,'Max'))
    a=3;
elseif (get(S.axle4_radiobutton,'Value') == get(S.axle2_radiobutton,'Max'))
    a=4;
elseif (get(S.axle5_radiobutton,'Value') == get(S.axle2_radiobutton,'Max'))
    a=5;
end
axle_dolly(p)=0;
axle_trailer(p)=a;
...
elseif t2==5 && a==2
    p2name = 'FT1+1';
    axes(S.axes1);
    bg = imread('trailer_2a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('trailer_2a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
...
elseif t2==5 && a==3
    p2name = 'FT1+2';
    axes(S.axes1);
    bg = imread('trailer_3a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('trailer_3a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
...
elseif t2==5 && a==4
    p2name = 'FT2+2';
    axes(S.axes1);
    bg = imread('trailer_4a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('trailer_4a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
...
elseif t2==6 && a==1
    p2name = 'CT1';
    axes(S.axes1);
    bg = imread('dbtrailer_1a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('dbtrailer_1a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.dbmass_text,'Visible','On')
    set(S.dbmass_edit,'Visible','On')
    name='drawbar_trailer_1axles';
elseif t2==6 && a==2
    p2name = 'CT2';
    axes(S.axes1);
    bg = imread('dbtrailer_2a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('dbtrailer_2a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
    set(S.dbmass_text,'Visible','On')
    set(S.dbmass_edit,'Visible','On')
    name='drawbar_trailer_2axles';
elseif t2==6 && a==3
    p2name = 'CT3';
    axes(S.axes1);
    bg = imread('dbtrailer_3a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('dbtrailer_3a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
    ...
    set(S.dbmass_text,'Visible','On')
    set(S.dbmass_edit,'Visible','On')
    name='drawbar_trailer_3axles';
elseif t2==6 && a==4
    p2name = 'CT4';
    axes(S.axes1);
    bg = imread('dbtrailer_4a_dim1.bmp');
    image(bg);
    axis off;
    axes(S.axes2);
    bg = imread('dbtrailer_4a_dim2.bmp');
    image(bg);
    axis off;
    set(S.panel_axle_1,'Visible','on')
    set(S.panel_axle_2,'Visible','on')
...
valaxle=3;
set(S.axle1tyres_popupmenu,'Value',valaxle);
set(S.axle2tyres_popupmenu,'Value',valaxle);
set(S.axle3tyres_popupmenu,'Value',valaxle);
set(S.axle4tyres_popupmenu,'Value',valaxle);
set(S.axle5tyres_popupmenu,'Value',valaxle);

Trailer_nodoll_initialize %put values in edit boxes
...
global start_window
start_window=0;
global a c file_name name name_buffer p t2 trailer_name truck_name x1 x2 trailer_code

if t2==1 && a==4
    A=str2double(get(S.axle1xpos_edit,'String')); % [m]
    B=str2double(get(S.axle2xpos_edit,'String')); % [m]
    K=str2double(get(S.chassislenght_edit,'String')); % [m]
    J=str2double(get(S.ftoconn_edit,'String')); % [m]

    if (J+A)<(K/2)
        name='semitrailer_41axles';
        trailer_code(p)=11; %Indicates the type of trailer
    end
    if (J+A+B)<(K/2)
        name='semitrailer_42axles';
        trailer_code(p)=12; %Indicates the type of trailer
    end
end    
...
if a>=4
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select28'),'Position', [70 1350 75 1380])
...
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/acceleration_a4'),'Position', [170 1350 270 1380])
...
if a==5
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select32'),'Position', [70 1550 75 1580])
...
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/acceleration_a5'),'Position', [170 1550 270 1580])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select16/1','position_a2/1')
    ...
    %Position of axle 3
if a==3
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select17'),'Position', [70 600 75 630])
...
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/position_a3'),'Position', [170 600 270 630])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select17/1','position_a3/1')
    ...
    %Position of axle 4
if a==4
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select29'),'Position', [70 600 75 630])
...
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/position_a4'),'Position', [170 600 270 630])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select29/1','position_a4/1')
    ...
    %Position of axle 5
if a==5
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select33'),'Position', [70 1600 75 1630])
...
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/position_a5'),'Position', [170 1600 270 1630])
...
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select18'),'Position', [70 650 75 680])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select18/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select18'),'OutputSignals','axle1.traileraxle_posright')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionright_a1'),'Position', [170 650 270 680])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select18/1','positionright_a1/1')

    %Position - right of axle 2
if a>=2
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select19'),'Position', [70 700 75 730])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select19/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select19'),'OutputSignals','axle2.traileraxle_posright')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionright_a2'),'Position', [170 700 270 730])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select19/1','positionright_a2/1')
end

    %Position - right of axle 3
if a>=3
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select20'),'Position', [70 750 75 780])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select20/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select20'),'OutputSignals','axle3.traileraxle_posright')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionright_a3'),'Position', [170 750 270 780])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select20/1','positionright_a3/1')
end

    %Position - right of axle 4
if a>=4    
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select30'),'Position', [70 1450 75 1480])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select30/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select30'),'OutputSignals','axle4.traileraxle_posright')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionright_a4'),'Position', [170 1450 270 1480])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select30/1','positionright_a4/1')
end

    %Position - right of axle 5
if a==5
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select34'),'Position', [70 1650 75 1680])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select34/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select34'),'OutputSignals','axle5.traileraxle_posright')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionright_a5'),'Position', [170 1650 270 1680])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select34/1','positionright_a5/1')
end

    %Position - left of axle 1
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select21'),'Position', [70 800 75 830])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select21/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select21'),'OutputSignals','axle1.traileraxle_posleft')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionleft_a1'),'Position', [170 800 270 830])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select21/1','positionleft_a1/1')

    %Position - left of axle 2
if a>=2
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select22'),'Position', [70 850 75 880])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select22/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select22'),'OutputSignals','axle2.traileraxle_posleft')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionleft_a2'),'Position', [170 850 270 880])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select22/1','positionleft_a2/1')
end

    %Position - left of axle 3
if a>=3
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select23'),'Position', [70 900 75 930])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select23/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select23'),'OutputSignals','axle3.traileraxle_posleft')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionleft_a3'),'Position', [170 900 270 930])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select23/1','positionleft_a3/1')
end

    %Position - left of axle 4
if a>=4
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select31'),'Position', [70 1500 75 1530])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select31/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select31'),'OutputSignals','axle4.traileraxle_posleft')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionleft_a4'),'Position', [170 1500 270 1530])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select31/1','positionleft_a4/1')
end

    %Position - left of axle 5
if a==5
add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select35'),'Position', [70 1700 75 1730])
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select35/1','autorouting','on')
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select35'),'OutputSignals','axle5.traileraxle_posleft')
add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/positionleft_a5'),'Position', [170 1700 270 1730])
...
add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select35/1','positionleft_a5/1')
end
...
if t2==6
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select8'),'OutputSignals','trailerload.loadcenter_acc')    
elseif t2==5
set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select8'),'OutputSignals','trailerload1.loadcenter_acc')
else
...
if t2==1 || t2==3
    ...
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select24'),'Position', [70 950 75 980])
    ...
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/semi_right'),'Position', [170 950 270 980])
    ...
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select25'),'Position', [70 1000 75 1030])
    ...
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/semi_left'),'Position', [170 1000 270 1030])
    ...
    %Position tail 
if t2==1 || t2==3 %semitrailer
        %Position tail right
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select26'),'Position', [70 1050 75 1080])
    ...
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_right'),'Position', [170 1050 270 1080])
    ...
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select26/1','tail_right/1')
         %Position tail left
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select27'),'Position', [70 1100 75 1130])
    ...
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_left'),'Position', [170 1100 270 1130])
...
elseif t2==6 %dbtrailer
        %Position tail right
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select26'),'Position', [70 1150 75 1180])
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select26/1','autorouting','on')
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select26'),'OutputSignals','trailerload.tail_positionright')
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_right'),'Position', [170 1150 270 1180])
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_right'),'VariableName',strcat('s_trailer',num2str(p),'_load_posright'),'MaxDataPoints','inf','Decimation','1','SampleTime','-1','SaveFormat','Array','BackgroundColor','Orange')
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select26/1','tail_right/1')
         %Position tail left
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select27'),'Position', [70 1200 75 1230])
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select27/1','autorouting','on')
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select27'),'OutputSignals','trailerload.tail_positionleft')
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_left'),'Position', [170 1200 270 1230])
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_left'),'VariableName',strcat('s_trailer',num2str(p),'_load_posleft'),'MaxDataPoints','inf','Decimation','1','SampleTime','-1','SaveFormat','Array','BackgroundColor','Orange')
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select27/1','tail_left/1')
    
elseif t2==5 %trailer
        %Position tail right
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select26'),'Position', [70 1250 75 1280])
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select26/1','autorouting','on')
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select26'),'OutputSignals','trailerload2.tail_positionright')
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_right'),'Position', [170 1250 270 1280])
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_right'),'VariableName',strcat('s_trailer',num2str(p),'_load_posright'),'MaxDataPoints','inf','Decimation','1','SampleTime','-1','SaveFormat','Array','BackgroundColor','Orange')
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select26/1','tail_right/1')
         %Position tail left
    add_block('built-in/BusSelector',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select27'),'Position', [70 1300 75 1330])
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'In1/1','select27/1','autorouting','on')
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/select27'),'OutputSignals','trailerload2.tail_positionleft')
    add_block('built-in/ToWorkspace',strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_left'),'Position', [170 1300 270 1330])
    set_param(strcat(file_name,'/To_workspace_trailer_',num2str(p),'/tail_left'),'VariableName',strcat('s_trailer',num2str(p),'_load_posleft'),'MaxDataPoints','inf','Decimation','1','SampleTime','-1','SaveFormat','Array','BackgroundColor','Orange')
    add_line(strcat(file_name,'/To_workspace_trailer_',num2str(p)),'select27/1','tail_left/1')
end

fill_in_trailer_nodoll_model
